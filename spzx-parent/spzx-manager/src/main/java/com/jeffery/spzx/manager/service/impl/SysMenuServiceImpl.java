...
import com.jeffery.spzx.manager.mapper.SysMenuMapper;
import com.jeffery.spzx.manager.mapper.SysRoleMenuMapper;
import com.jeffery.spzx.manager.service.SysMenuService;
import com.jeffery.spzx.manager.utils.MenuHelper;
import com.jeffery.spzx.model.entity.system.SysMenu;
...
public class SysMenuServiceImpl implements SysMenuService {
    ...
    public void removeById(Long id) {
        ...
        //判断，count大于0，包含子菜单
        if(count > 0) {
            throw new JefferyException(ResultCodeEnum.NODE_ERROR);
        }
