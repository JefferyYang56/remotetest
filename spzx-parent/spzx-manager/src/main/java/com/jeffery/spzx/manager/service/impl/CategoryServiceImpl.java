...
import com.jeffery.spzx.manager.listener.ExcelListener;
import com.jeffery.spzx.manager.mapper.CategoryMapper;
import com.jeffery.spzx.manager.service.CategoryService;
import com.jeffery.spzx.model.entity.product.Category;
import com.jeffery.spzx.model.vo.common.ResultCodeEnum;
import com.jeffery.spzx.model.vo.product.CategoryExcelVo;
...
//                categoryExcelVo.setId(id);
            ...
            e.printStackTrace();
            throw new JefferyException(ResultCodeEnum.DATA_ERROR);
        }
    }
